...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2018 at 08:22 PM
...
(6, 'Hari T', 'hari', 'hari', '6.jpg', '0', 'yes', 'yes', 'yes', 0),
...
--
ALTER TABLE `posts`
  MODIFY `post_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=523;
...
--
ALTER TABLE `user_groups`
  MODIFY `ugroup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
